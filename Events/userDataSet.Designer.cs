...
namespace Events {
    ...
    public partial class userDataSet : global::System.Data.DataSet {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public userRow AdduserRow(string FirstName, string LastName, string City, string Address, string Interests, string Username, string Password) {
...
namespace Events.userDataSetTableAdapters {
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[user] ([FirstName], [LastName], [City], [Address], [Interests], [Username], [Password]) VALUES (@FirstName, @LastName, @City, @Address, @Interests, @Username, @Password);
SELECT ID, FirstName, LastName, City, Address, Interests, Username, Password FROM [user] WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[user] SET [FirstName] = @FirstName, [LastName] = @LastName, [City] = @City, [Address] = @Address, [Interests] = @Interests, [Username] = @Username, [Password] = @Password WHERE (([ID] = @Original_ID));
SELECT ID, FirstName, LastName, City, Address, Interests, Username, Password FROM [user] WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Events.Properties.Settings.Default.userConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, City, Address, Interests, Username, Password FROM" +
                " dbo.[user]";
        ...
        public virtual int Insert(string FirstName, string LastName, string City, string Address, string Interests, string Username, string Password) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string City, string Address, string Interests, string Username, string Password, int Original_ID, int ID) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string City, string Address, string Interests, string Username, string Password, int Original_ID) {
            return this.Update(FirstName, LastName, City, Address, Interests, Username, Password, Original_ID, Original_ID);
        }
    }
