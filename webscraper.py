...
headers = "post_name , post_start_date , post_end_date , post_place , post_address , post_description\n"
...
for container in containers:
	...
	f.write(post_name.replace(":", "") + "," + post_start_date + "," + post_end_date + "," + post_place + "," + post_address + "," + post_description.replace(",", "") + "\n")
