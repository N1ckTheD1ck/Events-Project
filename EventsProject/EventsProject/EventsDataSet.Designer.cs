...
namespace EventsProject {
    ...
    public partial class EventsDataSet : global::System.Data.DataSet {
        ...
        public partial class eventDataTable : global::System.Data.TypedTableBase<eventRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public eventRow AddeventRow(string description, string city, string place, string address, string category) {
        ...
        public partial class userDataTable : global::System.Data.TypedTableBase<userRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public userRow AdduserRow(string username, string password, System.DateTime birthday, string city, string address) {
...
namespace EventsProject.EventsDataSetTableAdapters {
    ...
    public partial class eventTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[event] ([description], [city], [place], [address], [category])" +
                " VALUES (@description, @city, @place, @address, @category);\r\nSELECT Id, descript" +
                "ion, city, place, address, category FROM event WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[event] SET [description] = @description, [city] = @city, [place] = " +
                "@place, [address] = @address, [category] = @category WHERE (([Id] = @Original_Id" +
                "));\r\nSELECT Id, description, city, place, address, category FROM event WHERE (Id" +
                " = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, description, city, place, address, category FROM dbo.event";
        ...
        public virtual int Fill(EventsDataSet.eventDataTable dataTable) {
        ...
        public virtual EventsDataSet.eventDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EventsDataSet.eventDataTable dataTable = new EventsDataSet.eventDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EventsDataSet.eventDataTable dataTable) {
        ...
        public virtual int Insert(string description, string city, string place, string address, string category) {
            if ((description == null)) {
        ...
        public virtual int Update(string description, string city, string place, string address, string category, int Original_Id, int Id) {
            if ((description == null)) {
                throw new global::System.ArgumentNullException("description");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string description, string city, string place, string address, string category, int Original_Id) {
            return this.Update(description, city, place, address, category, Original_Id, Original_Id);
        }
    }
    ...
    public partial class userTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[user] WHERE (([Id] = @Original_Id) AND ([birthday] = @Original" +
                "_birthday))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_Id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[user] ([username], [password], [birthday], [city], [address]) " +
                "VALUES (@username, @password, @birthday, @city, @address);\r\nSELECT Id, username," +
                " password, birthday, city, address FROM [user] WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[user] SET [username] = @username, [password] = @password, [birthday] = @birthday, [city] = @city, [address] = @address WHERE (([Id] = @Original_Id) AND ([birthday] = @Original_birthday));
SELECT Id, username, password, birthday, city, address FROM [user] WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT Id, username, password, birthday, city, address FROM dbo.[user]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(EventsDataSet.userDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual EventsDataSet.userDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EventsDataSet.userDataTable dataTable = new EventsDataSet.userDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EventsDataSet.userDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string username, string password, System.DateTime birthday, string city, string address) {
            if ((username == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, System.DateTime birthday, string city, string address, int Original_Id, System.DateTime Original_birthday, int Id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, System.DateTime birthday, string city, string address, int Original_Id, System.DateTime Original_birthday) {
            return this.Update(username, password, birthday, city, address, Original_Id, Original_birthday, Original_Id);
        }
    }
